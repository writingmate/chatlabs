              ...
              <div className="bg-token-main-surface-primary relative flex flex-col">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-foreground/60 mb-4 text-sm">
                    Access to most of the models and features. Suitable for most
                    users.
                  </p>
                  <div className="flex items-baseline gap-2">
                    ...
                    {billingCycle === "yearly" && (
                      <p className="text-foreground/50 line-through">$29.99</p>
                    )}
                  </div>
              ...
              <div className="bg-token-main-surface-primary relative flex flex-col">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    {billingCycle === "yearly" && (
                      <p className="text-foreground/50 line-through">$59.99</p>
                    )}
                  </div>
                  <p className="text-foreground/50 text-xs">
                    {billingCycle === "yearly"
