      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Button
            size={"icon"}
            variant={"link"}
            className="text-foreground hover:opactity-50 size-5 active:opacity-75"
      ...
      {showFooter && (
        <div className="bg-accent text-foreground flex items-center justify-end space-x-3 p-3 px-4">
          <Button
            ...
            variant={"link"}
            className={cn(
              "hover:opactity-50 size-5 active:opacity-75",
          ...
          <Button
            ...
            size={"icon"}
            className={cn(
              "console-toggle hover:opactity-50 size-5 active:opacity-75",
