...
export enum VALID_ENV_KEYS {
  ...
  JINA_API_KEY = "jina_f182e39f7f814d9d9c18ef59649491bbZegZBGmGfcSaFu-ap6i29IkJQtY_",
  JINA_MODEL_NAME = "jina-embeddings-v3",
  JINA_TASK_NAME = "text-matching",
  JINA_DIMENSION = 384,
  JINA_LATE_CHUNKING = 0,
  JINA_EMBEDDING_TYPE = "float",
