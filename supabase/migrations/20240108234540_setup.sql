...
AS $$
DECLARE
--  project_url TEXT := 'https://raafsylaihmmamcxldwm.supabase.co';
  project_url TEXT := 'http://supabase_kong_chatbotui:8000';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJhYWZzeWxhaWhtbWFtY3hsZHdtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNjQwOTEwOCwiZXhwIjoyMDQxOTg1MTA4fQ.C9NGXiaEs5z6PQAO38X0XsOxl8PbXrX5YAE4-_FPX2k'; -- full access needed for http request to storage
