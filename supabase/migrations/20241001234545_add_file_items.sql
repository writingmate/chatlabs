...
create table file_items (
  ...
  jina_embedding vector(384), -- 384 works for local w/ Xenova/all-MiniLM-L6-v2
...
CREATE INDEX file_items_jina_embedding_idx ON file_items
  USING hnsw (jina_embedding vector_cosine_ops);
...
create function match_file_items_jina (
